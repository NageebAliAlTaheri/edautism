...
class SymptomsPageWidget extends StatefulWidget {
  const SymptomsPageWidget({super.key});

  @override
  State<SymptomsPageWidget> createState() => _SymptomsPageWidgetState();
}
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  context.pushNamed('SlociPage');
                                },
                                child: Image.asset(
                                  'assets/images/solok1.jpeg',
                                  width: double.infinity,
                                  height: 300.0,
                                  fit: BoxFit.cover,
                                ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    '53v73jjq' /* صعوبات في المهارات اللغوية */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'gaxkrjsz' /* صعوبات في العلاقات الاجتماعية */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
