...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    userStream = edAutismFirebaseUserStream()
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: FloatingNavbar(
        ...
        selectedItemColor: FlutterFlowTheme.of(context).customColor4,
        ...
        items: [
          ...
          FloatingNavbarItem(
            customWidget: Column(
              ...
              children: [
                Icon(
                  currentIndex == 1 ? Icons.settings : Icons.settings,
          ...
          FloatingNavbarItem(
            customWidget: Column(
              ...
              children: [
                Icon(
                  currentIndex == 2 ? Icons.login : Icons.login,
